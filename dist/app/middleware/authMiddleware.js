...
var checkLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        try {
            ...
            jwt.verify(token, "PW", function (err, decoded) { return __awaiter(void 0, void 0, void 0, function () {
                var user, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            err_1 = _a.sent();
                            return [2 /*return*/, res.status(500).send("Lỗi khi truy vấn người dùng")];
